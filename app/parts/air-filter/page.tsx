      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-6 text-center">
            Used Air Filter in millions. Find in our live inventory of more than 72 warehouse.
          </h1>

          <div className="grid md:grid-cols-2 gap-8 mt-8">
            <div className="flex flex-col">
              <div className="relative h-[400px] mb-6">
                <Image src="/images/air-filter.png?height=400&width=400" alt="Air Filter" fill className="object-contain" />
              </div>
            ...
            <div>
              <PartForm selectedPart="Air Filter" />
            </div>
          </div>
        </div>
      </main>
